...
Presentamos un modelo simple, utilizando datos recolectados en Chile desde el 2009 al 2025. Este modelo es facilmente replicable con otros datos, ya se de una región más acotada o a una escala más amplia. Desarrollamos este modelo para ser útil para estimar abundancia y tendencias en cualquier país o región que cuenten con esquemas de monitoreo estandarizados. Adicionalmente, el modelo es fácilmente extendido para incluir efectos de variables fijas o aleatorias atingentes a cada situación.
